...
public class UsuarioResponseDTO {
    ...
    @JsonProperty("usuConsecutivo")
    private int usuConsecutivo;
    ...
    public UsuarioResponseDTO(int usuConsecutivo, int tpd, String identificacion, Integer dv,
        ...
        this.usuConsecutivo = usuConsecutivo;
        this.tpd = tpd;
    ...
    // Getters y Setters
    public int getUsuConsecutivo() { return usuConsecutivo; }
    public void setUsuConsecutivo(int usuConsecutivo) { this.usuConsecutivo = usuConsecutivo; }
